...
export function AboutSection() {
  return (
    <section className="pt-60 pb-24 bg-white dark:bg-[#18181B]" id="about">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="mb-1">
            ...
            <div className="mt-60 max-w-4xl">
              <div className="space-y-20">
                {/* Philosophy 1 */}
                <div className="group relative">
                  <div className="flex items-center gap-6 mb-8">
                    <div className="w-1 h-12 bg-emerald-600 group-hover:h-16 transition-all duration-500 ease-out"></div>
                    <h3 className="text-4xl md:text-5xl font-neue-montreal font-light text-emerald-800 dark:text-emerald-600 group-hover:font-medium transition-all duration-300">
                      Start With Why
                    </h3>
                  </div>
                  <div className="ml-7">
                    <div className="relative">
                      <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 leading-relaxed font-neue-montreal group-hover:text-gray-800 dark:group-hover:text-gray-200 transition-colors duration-300">
                ...
                <div className="group relative">
                  <div className="flex items-center gap-6 mb-8">
                    <div className="w-1 h-12 bg-amber-600 group-hover:h-16 transition-all duration-500 ease-out"></div>
                    <h3 className="text-4xl md:text-5xl font-neue-montreal font-light text-amber-800 dark:text-amber-600 group-hover:font-medium transition-all duration-300">
                      Attention To Detail
                    </h3>
                  </div>
                  <div className="ml-7">
