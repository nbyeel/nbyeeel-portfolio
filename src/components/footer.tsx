...
export function Footer() {
  ...
  return (
    <section className="mt-[15px] flex flex-col rounded-t-[56px] bg-emerald-800" id="footer">
      <div className="font-neue-montreal-book relative z-0 mx-auto mt-[200px] flex w-full max-w-[1440px] flex-col items-center gap-4">
        <div className="flex w-full flex-col gap-4 px-6">
          ...
          <div className="mb-20 mt-40 flex flex-col gap-0">
            <h1 className="font-neue-montreal-medium pointer-events-none relative -z-10 w-auto overflow-hidden capitalize leading-tight tracking-normal lg:-mb-32 text-[80px] lg:text-[200px] xl:text-[300px] font-neue-montreal-book !text-emerald-400">
              Socials
          ...
          <div className="mx-auto mt-4 flex w-full flex-col items-center gap-4 md:flex-row">
            ...
            >
              ...
              <div className="flex-col items-center justify-start">
                <div className="z-20 text-[38px]">LinkedIn</div>
            ...
            >
              <span className="absolute bottom-[-6px] left-0 size-full rounded-[64px] bg-emerald-700/10 transition-all duration-300 group-hover:bottom-[-12px]"></span>
              <div className="flex-col items-center justify-start">
                <div className="z-20 text-[38px]">Instagram</div>
                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512" className="ml-2 inline-block size-12" height="1em" width="1em">
            ...
            >
              <span className="absolute bottom-[-6px] left-0 size-full rounded-[64px] bg-emerald-700/10 transition-all duration-300 group-hover:bottom-[-12px]"></span>
              <div className="flex-col items-center justify-start">
                <div className="z-20 text-[38px]">Upwork</div>
      ...
      <div className="relative flex w-full flex-col items-center overflow-hidden text-clip bg-gradient-to-t from-amber-800 via-amber-800 to-emerald-800">
        <div className="h-[700px] w-full flex items-end justify-center pb-50">
          <div className="px-8">
                          <h3 className="w-auto font-bold leading-tight tracking-normal text-emerald-300 dark:text-emerald-400 text-9xl md:text-[200px] font-pp-neue-montreal text-gray-700/20 dark:text-gray-700/20">
              Thank you!
            </h3>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center gap-4 py-[50px]">
          ...
          <div className="flex items-center justify-center gap-4 text-zinc-400 *:fill-amber-400 dark:text-zinc-600">
            ...
            <a target="_blank" className="text-amber-600 transition-all duration-500 hover:text-amber-300" href="https://instagram.com/your-instagram">
